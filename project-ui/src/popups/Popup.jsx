...
const PopupEquip = ({ equipamento, onClose, onOptionClick }) => {
  ...
  const handleOptionClick = (tipo) => {
    setShowMenu(false);
    if (onOptionClick) {
      // Passa apenas o tipo como string ("Corretiva" ou "Preventiva")
      onOptionClick(tipo);
    }
  };
              ...
              <div className="config-menu">
                ...
                {showMenu && (
                  <div className="dropdown-menu">
                    <button onClick={() => handleOptionClick("Corretiva")}>
                      Corretiva
                    </button>
                    <button onClick={() => handleOptionClick("Preventiva")}>
                      Preventiva
                    </button>
                  </div>
                )}
                ...
                <div className="grid-item">
                  ...
                  <span>
                    ...
                    {equipamento.valorCompra
                      ? equipamento.valorCompra.toFixed(2)
                      : "0.00"}
                  </span>
                </div>
                <div className="grid-item">
                ...
                <div className="arquivos-container">
                  {equipamento.arquivos.map((arquivos, index) => (
                    <div key={index} className="anexo-item">
                      ...
                      <span
                        onClick={() => handleOpenPdf(arquivos)}
